...
dependencies {
    ...
    compile group: 'com.ibm.mobile.services', name: 'imfdata-local', version: '1.0.0', ext: 'aar'
    compile group: 'com.ibm.mobile.services', name: 'cloudant-toolkit-local', version: '1.0.0', ext: 'aar'
}
