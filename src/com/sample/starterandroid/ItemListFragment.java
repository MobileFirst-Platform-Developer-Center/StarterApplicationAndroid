...
public class ItemListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter = new ArrayAdapter<Content.Item>(getActivity(),
		...
		try{
			...
			client = WLClient.createInstance(this.getActivity());
		}
		client.connect(new MyConnectListener(adapter, this.getActivity()));
	}
